                            ...
                            <tr v-for = "(a,index) in applications" :key = "a.id">
                                <td id = "tenderID">
                                    ...
                                    <div class = "modal-lg" modal-xl id = "tenderIdModal" >
                                        <!-- Modal -->
                                        <div class="modal fade" :id="'modal_'+a.id" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                        ...
                                                        <div class = "container-fluid">
                                                            ...
                                                            <div class = "row fw-bold">
                                                                ...
                                                                <div class = "col-md-4 d-flex">
                                                                    <h5 class = "align-bottom float-end" id = "statusLabel">Status: 
                                                                        <span :class = "getColour(a.data().status)" 
                                                                        class = "fw-bold"> {{a.data().status}} </span> 
                                                                    </h5>
                                                                </div>                 
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="card" >
                                                            <div class=" card-header text-md-start"> Personal Details </div>
                                                            <div class = "container-fluid">
                                                                <div class="card-body">
                                                                    <div class="row">
                                ...
                                <td id = "actions">
                                    <div class = "d-flex justify-content-lg-between">
                                        <button id = "editButton" @click = "checkStatus(a) ? editForm(a.id) : null" 
                                        :class = "[checkStatus(a) ? 'btn-success' : 'btn-secondary']" > 
