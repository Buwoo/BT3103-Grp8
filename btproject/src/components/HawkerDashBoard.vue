<template>
  ...
  <div class="webpage">
    <div class="container-fluid">
      ...
      <!-- Tender Table-->
      <div class="table-responsive" id="wholeTable">
        <table class="table">
          <thead>
            <tr>
                          ...
                          <div class="container-fluid">
                            ...
                            <div class="row fw-bold">
                              ...
                              <div class="col-md-4 d-flex">
                                <h5
                                  class="align-bottom float-end"
                                  id="statusLabel"
                                >
                                  Status:
                                  <span
                                    :class="getColour(a.data().status)"
                                    class="fw-bold"
                                  >
                                    {{
                                      a.data().status.charAt(0).toUpperCase() +
                                      a.data().status.slice(1)
                                    }}
                                  </span>
                                </h5>
                              </div>
              ...
              <td id="actions">
                <div class="d-flex justify-content-center">
                  <button
                    type="button"
                    id="editButton"
                    @click="checkStatus(a) ? editForm(a.id) : null"
                    :class="[
                      checkStatus(a) ? 'btn btn-success' : 'btn btn-secondary',
                    ]"
                  >
                  ...
                  <button
                    id="deleteButton"
                    type="button"
                    @click="checkStatus(a) ? deleteForm(index, a) : null"
                    :class="[
                      checkStatus(a) ? 'btn btn-danger' : 'btn btn-secondary',
                    ]"
                  >
